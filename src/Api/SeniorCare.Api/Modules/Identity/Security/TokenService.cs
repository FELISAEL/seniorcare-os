...
namespace SeniorCare.Api.Modules.Identity.Security;

public sealed class TokenService(JwtOptions options)
{
    public LoginResponse Create(UserAccount user, string panelPath)
    {
    ...
    public static PublicUser ToPublic(UserAccount user) =>
        new(
            user.Id,
            user.Username,
            user.DisplayName,
