...
public sealed class IdentityRepository : IIdentityRepository, IAsyncDisposable
{
        ...
        PasswordHasher passwordHasher)
    {
        ...
        var connectionString = configuration.GetConnectionString("IdentityDatabase")
            ?? throw new InvalidOperationException(
                "No se configurÃ³ ConnectionStrings:IdentityDatabase.");
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await SeedUserAsync(
            ...
            _configuration["SEED_ADMIN_PASSWORD"] ?? "Cambiar123!",
            "admin",
            null,
            cancellationToken);
        ...
        await SeedUserAsync(
            ...
            "Cuidador de demostraciÃ³n",
            _configuration["SEED_CAREGIVER_PASSWORD"] ?? "Cuidador123!",
            "caregiver",
            null,
            cancellationToken);
        ...
        await SeedUserAsync(
            ...
            "MarÃ­a LÃ³pez",
            _configuration["SEED_RESIDENT_PASSWORD"] ?? "Maria123!",
            "resident",
            DemoResidentId,
            cancellationToken);
        ...
        await SeedUserAsync(
            ...
            "Ana LÃ³pez",
            _configuration["SEED_FAMILY_PASSWORD"] ?? "Familia123!",
            "family",
            DemoResidentId,
            cancellationToken);
    }
